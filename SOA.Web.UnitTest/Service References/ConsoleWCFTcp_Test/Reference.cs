...
namespace SOA.Web.UnitTest.ConsoleWCFTcp_Test {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ConsoleWCFTcp_Test.IMathService")]
    public interface IMathService {
        ...
        SOA.Web.UnitTest.ConsoleWCFTcp_Test.WCFUser GetUser(int x, int y);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMathService/GetUser", ReplyAction="http://tempuri.org/IMathService/GetUserResponse")]
        System.Threading.Tasks.Task<SOA.Web.UnitTest.ConsoleWCFTcp_Test.WCFUser> GetUserAsync(int x, int y);
        ...
        System.Collections.Generic.List<SOA.Web.UnitTest.ConsoleWCFTcp_Test.WCFUser> UserList();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMathService/UserList", ReplyAction="http://tempuri.org/IMathService/UserListResponse")]
        System.Threading.Tasks.Task<System.Collections.Generic.List<SOA.Web.UnitTest.ConsoleWCFTcp_Test.WCFUser>> UserListAsync();
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IMathServiceChannel : SOA.Web.UnitTest.ConsoleWCFTcp_Test.IMathService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class MathServiceClient : System.ServiceModel.ClientBase<SOA.Web.UnitTest.ConsoleWCFTcp_Test.IMathService>, SOA.Web.UnitTest.ConsoleWCFTcp_Test.IMathService {
        ...
        public SOA.Web.UnitTest.ConsoleWCFTcp_Test.WCFUser GetUser(int x, int y) {
            return base.Channel.GetUser(x, y);
        }
        
        public System.Threading.Tasks.Task<SOA.Web.UnitTest.ConsoleWCFTcp_Test.WCFUser> GetUserAsync(int x, int y) {
            return base.Channel.GetUserAsync(x, y);
        }
        
        public System.Collections.Generic.List<SOA.Web.UnitTest.ConsoleWCFTcp_Test.WCFUser> UserList() {
            return base.Channel.UserList();
        }
        
        public System.Threading.Tasks.Task<System.Collections.Generic.List<SOA.Web.UnitTest.ConsoleWCFTcp_Test.WCFUser>> UserListAsync() {
