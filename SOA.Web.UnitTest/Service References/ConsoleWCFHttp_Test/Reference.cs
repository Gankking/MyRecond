...
namespace SOA.Web.UnitTest.ConsoleWCFHttp_Test {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ConsoleWCFHttp_Test.IMathService")]
    public interface IMathService {
        ...
        SOA.Web.UnitTest.ConsoleWCFHttp_Test.WCFUser GetUser(int x, int y);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMathService/GetUser", ReplyAction="http://tempuri.org/IMathService/GetUserResponse")]
        System.Threading.Tasks.Task<SOA.Web.UnitTest.ConsoleWCFHttp_Test.WCFUser> GetUserAsync(int x, int y);
        ...
        SOA.Web.UnitTest.ConsoleWCFHttp_Test.WCFUser[] UserList();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMathService/UserList", ReplyAction="http://tempuri.org/IMathService/UserListResponse")]
        System.Threading.Tasks.Task<SOA.Web.UnitTest.ConsoleWCFHttp_Test.WCFUser[]> UserListAsync();
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IMathServiceChannel : SOA.Web.UnitTest.ConsoleWCFHttp_Test.IMathService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class MathServiceClient : System.ServiceModel.ClientBase<SOA.Web.UnitTest.ConsoleWCFHttp_Test.IMathService>, SOA.Web.UnitTest.ConsoleWCFHttp_Test.IMathService {
        ...
        public SOA.Web.UnitTest.ConsoleWCFHttp_Test.WCFUser GetUser(int x, int y) {
            return base.Channel.GetUser(x, y);
        }
        
        public System.Threading.Tasks.Task<SOA.Web.UnitTest.ConsoleWCFHttp_Test.WCFUser> GetUserAsync(int x, int y) {
            return base.Channel.GetUserAsync(x, y);
        }
        
        public SOA.Web.UnitTest.ConsoleWCFHttp_Test.WCFUser[] UserList() {
            return base.Channel.UserList();
        }
        
        public System.Threading.Tasks.Task<SOA.Web.UnitTest.ConsoleWCFHttp_Test.WCFUser[]> UserListAsync() {
