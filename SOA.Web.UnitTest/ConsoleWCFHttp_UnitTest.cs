...
{
    [TestClass]
    public class ConsoleWCFHttp_UnitTest
    {
        [TestMethod]
        public void TestConsoleWCFHttp_UnitTest()
        {
            //WCF使用try catch，而WebService使用using
            ConsoleWCFHttp_Test.MathServiceClient client = null;
            try
            {
                client = new ConsoleWCFHttp_Test.MathServiceClient();
